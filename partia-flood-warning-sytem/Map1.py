...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 27 23:27:06 2017
...
df = pd.read_csv('/Users/Sujay/partia-flood-warning-sytem/station_coord2.csv')
df.head()
...
data = [ dict(
        ...
        marker = dict( 
            ...
            colorscale = scl,
            cmin = df['Water Level'].min(),
            color = df['Water Level'],
            cmax = df['Water Level'].max(),
            colorbar=dict(
                title="Latest water levels Feb 2017"
            )
        ))]
